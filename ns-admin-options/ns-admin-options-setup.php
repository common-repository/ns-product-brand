...
add_action( 'admin_menu', function()  {
    add_menu_page( 'Product Brand', 'Product Brand', 'manage_options', plugin_dir_path( __FILE__ ).'ns_admin_option_dashboard.php', '', plugin_dir_url( __FILE__ ).'img/backend-sidebar-icon.png', 60);
...
add_action( 'admin_enqueue_scripts', function() {
	...
	wp_enqueue_script( 'ns-option-js-page-product', plugins_url( '/js/ns-option-js-page-product.js' , __FILE__ ), array( 'jquery' ) );
});
?>